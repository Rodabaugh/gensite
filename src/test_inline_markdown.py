...
class TestInlineMarkdown(unittest.TestCase):
    ...
    def test_split_links(self):
        node = TextNode(
            "This is text with a [link](https://erikrodabaugh.com/) and [another link](https://freemy.cloud) with text that follows",
            text_type_text,
        )
        ...
        self.assertListEqual(
            [
                TextNode("This is text with a ", text_type_text),
                TextNode("link", text_type_link, "https://erikrodabaugh.com/"),
                TextNode(" and ", text_type_text),
                TextNode("another link", text_type_link, "https://freemy.cloud"),
